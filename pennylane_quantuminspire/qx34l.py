...
"""
This module contains the :class:`~.QX34LDevice` class, a PennyLane device for the QuantumInspire QX emulator on
Lisa SurfSara backend.
"""
...
class QX34LDevice(QuantumInspireDevice):
    """A PennyLane device for the QuantumInspire QX emulator on Lisa SurfSara backend.
    ...
    Args:
        ...
        shots (int): number of circuit evaluations/random samples used to estimate expectation values and
            ...
            Currently the maximum number of shots is 4096 for QX emulator on Lisa SurfSara backend.
