...
class Spin2Device(QuantumInspireDevice):
    """A PennyLane device for the QuantumInspire Spin-2 hardware backend.
    ...
    Args:
        wires (int or Iterable[Number, str]): Number of subsystems represented by the device,
            ...
            Currently this value is fixed for Spin-2 backend and should be 2.
        shots (int): number of circuit evaluations/random samples used to estimate expectation values and
            variances of observables.
            Currently the maximum number of shots is 4096 for Spin-2 backend.
