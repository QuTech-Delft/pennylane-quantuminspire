...
extra_requirements = {
    'dev': ['pytest>=3.3.1', 'pytest-cov', 'pytest-mock', 'pytest-benchmark', 'pylint', 'mypy>=0.670', 'black',
            'flaky'],
    'rtd': ['docutils==0.20.1', 'ipykernel==6.25.2', 'jinja2==3.1.2', 'mthree==2.6.3', 'nbsphinx==0.9.6',
