...
extra_requirements = {
    ...
    'rtd': ['docutils==0.19', 'ipykernel==6.22.0', 'jinja2==3.1.2', 'mthree==2.4.0', 'nbsphinx==0.9.1',
            'pybind11==2.10.4', 'pygments==2.15.0', 'pygments-github-lexers==0.0.5', 'sphinxcontrib-bibtex==2.5.0',
