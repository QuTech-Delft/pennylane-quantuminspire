...
extra_requirements = {
    ...
    'rtd': ['docutils==0.20.1', 'ipykernel==6.23.2', 'jinja2==3.1.2', 'mthree==2.5.1', 'nbsphinx==0.9.2',
            'pybind11==2.10.4', 'pygments==2.15.1', 'pygments-github-lexers==0.0.5', 'sphinxcontrib-bibtex==2.5.0',
