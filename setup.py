...
extra_requirements = {
    ...
    'rtd': ['docutils==0.19', 'ipykernel==6.19.2', 'jinja2==3.1.2', 'mthree==1.1.0', 'nbsphinx==0.8.10',
            'pybind11==2.10.2', 'pygments==2.13.0', 'pygments-github-lexers==0.0.5', 'sphinxcontrib-bibtex==2.5.0',
